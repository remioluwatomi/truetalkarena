...
class RaveController extends Controller
{
    public function processPayment(Request $request)
    {
        ...
        // totalAmount
        if (isset($postData['totalAmount'])) {
            $postData['amount'] = $postData['totalAmount'];
        }
        // dd($postData);
        ...
        if (isset($postData['amount'])) {
            ...
            $_SESSION['env'] = $env;
            $_SESSION['successurl'] = '/payment/redirect';
            $_SESSION['failureurl'] = '/payment/redirect';
            $_SESSION['amount'] = $postData['amount'];

            $postData['country'] = 'NG';
            $postData['description'] = '';
            $postData['currency'] = 'NGN';
            // $postData['country'] = 'UK';
            // $postData['description'] = '';
            // $postData['currency'] = 'GBP';
            $postData['logo'] = '';
            $postData['title'] = 'True Talk Arena';
            $postData['payment_options'] = 'card';
        }
