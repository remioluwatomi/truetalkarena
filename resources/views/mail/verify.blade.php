...
<body
    ...
    <span class="preheader"
        style="display: none !important; visibility: hidden; mso-hide: all; font-size: 1px; line-height: 1px; max-height: 0; max-width: 0; opacity: 0; overflow: hidden;">Thanks
        for trying out [Product Name]. We’ve pulled together some information and resources to help you get
        started.</span>
                ...
                <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation"
                    ...
                    <tr>
                        <td class="email-masthead"
                            ...
                            align="center">
                            <a href="{{ $details['SITE_ADDR'] }}" class="f-fallback email-masthead_name"
                                style="color: #A8AAAF; font-size: 16px; font-weight: bold; text-decoration: none; text-shadow: 0 1px 0 white;">
                                <img src="{{ $details['EMAIL_LOGO'] }}" alt="" width="50%">
                            </a>
                        </td>
                    </tr>
                    <!-- Email Body -->
                                    ...
                                    <td class="content-cell"
                                        ...
                                        <div class="f-fallback">
                                            <h1 style="margin-top: 0; color: #333333; font-size: 22px; font-weight: bold; text-align: left;"
                                                align="left">Welcome, {{ $details['TO_NAME'] }}!</h1>
                                            <p
           ...
           https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                                                        <table width="100%" border="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px;">
                                                                    <a href="{{ $details['CUSTOM_URL'] }}"
                                                                        class="f-fallback button" target="_blank"
                                                                        style="color: #FFF; border-color: #3869d4; border-style: solid; border-width: 10px 18px; background-color: #3869D4; display: inline-block; text-decoration: none; border-radius: 3px; box-shadow: 0 2px 3px rgba(0, 0, 0, 0.16); -webkit-text-size-adjust: none; box-sizing: border-box;">Verify</a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                            ...
                                            <p
                                                style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">
                                                For reference, here's your login information:</p>
                                                            ...
                                                            <tr>
                                                                <td class="attributes_item"
                                                                    ...
                                                                    <span class="f-fallback">
                                                                        ...
                                                                        {{ $details['SITE_ADDR'] }}/my-account/login
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                            ...
                                            <p
                                                ...
                                                If you have any questions, feel free to <a
                                                    href="mailto:{{ $details['REPLY_TO'] }}"
                                                    style="color: #3869D4;">email our
                                                    customer success team</a>. (We're lightning quick at replying.)
                                                {{-- <a href="{{ live_chat_url }}" style="color: #3869D4;">live
                                                    chat</a> during business hours. --}}
                                            </p>
                                            <p
                                                style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">
                                                Thanks,
                                                <br />Show Modern Kitchen and the Stilt-tech Team
                                            </p>
                                            {{-- <p
                                                style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">
                                                <strong>P.S.</strong> Need immediate help getting started? Check out our
                                                <a href="{{ help_url }}" style="color: #3869D4;">help
                                                    documentation</a>. Or, just reply to this email, the [Product Name]
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p class="f-fallback sub align-center"
                                            ...
                                            align="center">© 2021 Show Modern Kitchen. All rights reserved.</p>
                                        <p class="f-fallback sub align-center"
                                            style="font-size: 13px; line-height: 1.625; text-align: center; color: #A8AAAF; margin: .4em 0 1.1875em;"
                                            align="center">
                                            Show Modern Kitchen
