...
<head>
    ...
    <title>Gallery | True Talk Arena</title>
...
<body>
                                            ...
                                            @foreach ($gallery as $key => $item)
                                                <div class="col-md-4 grid-margin stretch-card">
                                                    <div class="card gallery">
                                                        <a href="#!">
                                                            <img src="/assets/img/gallery/{{ $item['image'] }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-xs-12">
                                    <input class="form-control" type="file"
                                        id="formFile"name="image"onchange="const file = this.files[0];
                                console.log(file);
                                if (file){
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            ...
                            <form class="updateGallery" method="post">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <img src="/assets/img/gallery/{{ $item['image'] }}" class=" w-100 rounded"
    ...
    <script src="/dashboard/js/gallery.js?v={{ env('APP_VERSION') }}"></script>
