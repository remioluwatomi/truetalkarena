...
<head>
    ...
    <title>Adverts | True Talk Arena</title>
...
<body>
                                        ...
                                        <div class="news row">
                                            ...
                                            @foreach ($adverts as $key => $item)
                                                <div class="col-md-4 grid-margin stretch-card">
                                                    <div class="card adverts">
                                                        <a href="#!">
                                                            <img src="/assets/img/adverts/{{ $item['advert_img'] }}"
                                                                class="card-img-top" alt="adverts Image">
                                                        </a>

                                                        <div class="card-body">
                                                            <h5 class="card-title">{{ $item['advert_title'] }}</h5>
                                                            <p class="card-text">{{ $item['advert_desc'] }}</p>
                                                            <button class="btn btn-outline-primary"
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#event-{{ $key }}"><i
                                                                    class="bx bx-pencil"></i></button>
                                                            <a class="btn btn-outline-primary"
                                                                href="{{ $item['advert_url'] }}"><i
        ...
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content">
                <div class="modal-header header-color-modal bg-color-2">
                    <h4 class="modal-title">Add Advert</h4>
                        ...
                        <form id="createEvent" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-xs-12">
                                    <input class="form-control" type="file"
                                        id="formFile"name="advert_img"onchange="const file = this.files[0];
                                console.log(file);
                                if (file){
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="advert_title" type="text" required>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="advert_url">Advert Link</label>
                                    <input class="form-control" name="advert_url" type="url" required>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="advert_desc">Advert Description</label>
                                    <textarea name="advert_desc" class="form-control" required></textarea>
                                </div>
                            </div>
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            ...
                            <form class="updateGallery" method="post">
                                <input type="hidden" name="advert_id" value="{{ $item['advert_id'] }}">
                                <div class="row">
                                    <div class="col-12">
                                        <img src="/assets/img/adverts/{{ $item['advert_img'] }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-xs-12">
                                        <input class="form-control" type="file" id="formFile"name="advert_img"
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="advert_title">Advert Title</label>
                                        <input class="form-control" name="advert_title"
                                            value="{{ $item['advert_title'] }}" type="text" required>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="advert_url">Advert Link</label>
                                        <input class="form-control" name="advert_url"
                                            value="{{ $item['advert_url'] }}" type="url" required>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="advert_desc">Advert Description</label>
                                        <textarea name="advert_desc" class="form-control" required>{{ $item['advert_desc'] }}</textarea>
                                    </div>
                                </div>
    ...
    <script src="/dashboard/js/advert.js?v={{ env('APP_VERSION') }}"></script>
